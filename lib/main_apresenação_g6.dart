    ...
    showDialog (
      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          onSubmitted: (_) => _salvarTarefa(), //Permite salvar a tarefa pressionando a tecla "Enter" no teclado
        ),
        actions: [
          TextButton(
            onPressed: () {
              _controller.clear(); //Limpa o campo de texto e fecha a janela de diálogo sem adicionar uma tarefa
              Navigator.pop(context);
              },          
            child: const Text('Cancelar'),
          ),
          ElevatedButton(
            onPressed: _salvarTarefa, //Chama a função para salvar a tarefa
